...
```
git clone https://github.com/cruxhan/py-github-analyzer.git
...
1. Visit GitHub Settings → Personal Access Tokens → Fine-grained tokens
...
1. Visit GitHub Settings → Personal Access Tokens → Tokens (classic)
...
```
py-github-analyzer https://github.com/owner/repo --github-token your_token_here
```
...
- **Issues**: [GitHub Issues](https://github.com/cruxhan/py-github-analyzer/issues)
- **Discussions**: [GitHub Discussions](https://github.com/cruxhan/py-github-analyzer/discussions)
